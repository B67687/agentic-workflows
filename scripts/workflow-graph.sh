...
if [[ "${1:-}" == "--inline" ]]; then
    ...
    echo '    <picture>'
    echo '      <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/B67687/agentic-workflows/main/workflow-graph.svg">'
    echo '      <img src="https://raw.githubusercontent.com/B67687/agentic-workflows/main/workflow-graph.svg" width="100%" alt="Workflow Diagram" style="max-width:1100px;">'
    echo '    </picture>'
    echo '  </a>'
