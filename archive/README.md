...
Preserved material that should stay available but should not sit on the hot path.

## Curated Archives

| File | Contents |
|---|---|
| `history-2026-04.md` | Full pre-optimization April session history. |
| `research-log-2026-04.md` | Full pre-optimization research log. |
